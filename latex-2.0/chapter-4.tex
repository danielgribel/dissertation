...
\caption{The algorithms error from the best known solutions vs the number of clusters (Instances A1)}
\label{fig:error-A1}
\end{figure}
...
\caption{The algorithms error from the best known solutions vs the number of clusters (Instances A2)}
\label{fig:error-A2}
\end{figure}
...
%For instances of group A2, HGKM demands more computational efforts than MS-MGKM, MGKM, GKM and DCClust for all values of $m$.
